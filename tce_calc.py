...
def route_eca_calcs(c, data):
    days_loading, days_discharging, days_waiting, days_canal = c['Days-Loading'], c['Days-Discharging'], c['Days-Waiting'], c['Days-Canal']
    ...
    data['Total voyage days'] = days_ballast_non_eca + days_laden_non_eca + days_ballast_eca + days_laden_eca + days_loading + days_discharging + days_waiting + days_canal
    return data
